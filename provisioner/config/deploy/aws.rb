...
server '51.1.0.50', user: 'root', password: 'PH_GEX_PASSWD1', roles: %w{master}, no_release: true
server '51.1.0.50', user: 'root', password: 'PH_GEX_PASSWD1', roles: %w{openvpn}, no_release: true
server '51.1.0.50', user: 'root', password: 'PH_GEX_PASSWD1', roles: %w{proxy}, no_release: true
server '51.1.0.50', user: 'root', password: 'PH_GEX_PASSWD1', roles: %w{webproxy}, no_release: true
